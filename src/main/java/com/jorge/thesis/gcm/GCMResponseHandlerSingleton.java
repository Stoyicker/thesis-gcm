    ...
    void handleGCMResponse(Request request, Response response) {
        ...
        try {
            ...
            try {
                ...
                //Will never happen
                return; //Let compiler know that "body" is always going to be alright if used
            }
            if (responseCode == 200) {
                try {
                    if (((!body.get("failure").toString().contentEquals("0") || !body.get("canonical_ids").toString()
                            .contentEquals("0")))) {
                            ...
                            try {
                                ...
                                switch (obj.getString("error")) {
                                    ...
                                    case "InvalidRegistration":
                                        throw new IllegalStateException("GCM Error response InvalidRegistration - See" +
                                                " " +
                                                "https://developer.android.com/google/gcm/http.html#error_codes for " +
                                                "more " +
                                                "information.");
                                    case "MismatchSenderId":
                                        throw new IllegalStateException("GCM Error response MismatchSenderId - See " +
                                                "https://developer.android.com/google/gcm/http.html#error_codes for " +
                                                "more " +
                                                "information.");
                                    case "MessageTooBig":
                                    ...
                                    case "InternalServerError":
                                        throw new IllegalStateException("GCM Error response InternalServerError - See" +
                                                " " +
                                                "https://developer.android.com/google/gcm/http.html#error_codes for " +
                                                "more " +
                                                "information.");
                                    case "InvalidPackageName":
                                        throw new IllegalStateException("GCM Error response InvalidPackageName - See " +
                                                "https://developer.android.com/google/gcm/http.html#error_codes for " +
                                                "more " +
                                                "information.");
                                    case "DeviceMessageRateExceeded":
                                        throw new IllegalStateException("GCM Error response DeviceMessageRateExceeded" +
                                                " - " +
                                                "See " +
                                                "https://developer.android.com/google/gcm/http.html#error_codes for " +
                                                "more " +
                ...
                System.err.println("Unexpected GCM response code " + responseCode + "\nRetrying with exponential " +
                        "back-off...");
                //TODO Readd the whole request using exp. back-off
            }
        } catch (IOException e) {
